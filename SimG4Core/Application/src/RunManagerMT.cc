...
void RunManagerMT::addRegions() {
  ...
  std::vector<mat_cut_couple_t> mat_cut_couple_vector = {
    ...
    {"StainlessSteel","^HGCalHESteelCover.*",0.1},
    {"StainlessSteel","^HGCalHEAbsorber.*",10},
    {"StainlessSteel","^HGCalBackPlate.*",10},
    {"HGC_Cables","^HGCalCableConnector.*",0.03},
  };
